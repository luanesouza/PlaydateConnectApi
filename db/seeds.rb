...
user1 = User.create(name: "Carla", role: "parent", email: "@test@gmail.com")
user2 = User.create(name: "Carol", role: "parent", email: "@test@gmail.com")
user3 = User.create(name: "Brenda", role: "parent", email: "@test@gmail.com")
user4 = User.create(name: "Sarah", role: "parent", email: "@test@gmail.com")
user5 = User.create(name: "Uena", role: "babysitter", email: "@test@gmail.com")
user6 = User.create(name: "Laura", role: "parent", email: "@test@gmail.com")
user7 = User.create(name: "Tonia", role: "parent", email: "@test@gmail.com")
user8 = User.create(name: "Gracie", role: "parent", email: "@test@gmail.com")
user9 = User.create(name: "John", role: "parent", email: "@test@gmail.com")
